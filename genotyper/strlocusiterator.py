...
class STRLocusIterator():
    ...
    The line format is tab-delimited:
        chrom, start, end, unit, region, flank1 sequence, flank2 sequence,
        repeat sequence, STR len list, strand list, mapq list.
    ...
    def next(self):
        while True:
            ...
            reads_mq = build_reads(fields[8], fields[9], fields[10], self.min_mapq)
            ...
            return (chrom, start, end, reflen, ref_unit, region,
                    flank1, flank2, seq, reads)
