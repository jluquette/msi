...
#    1465-heartbulk_D18JJACXX-L002_R2_C001.fastq.gz
#    <sample ID>_<readgroup ID>_<mate ID>_<chunk ID>.fastq.gz
# The various IDs may contain "-" but will not contain underscores.
def handle_input(fastq_files):
    result = {}
    ...
    # Second pass to determine total sample size, in bytes
